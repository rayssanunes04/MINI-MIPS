...
void unidade_controle(struct instrucao *inst, struct controle *ctrl) {
    ...
    if (inst->tipo_inst == tipo_R) {
        ...
        switch(inst->funct) {
            case 0: ctrl->alu_op = 0; break;
            case 1: ctrl->alu_op = 1; break;
            case 2: ctrl->alu_op = 2; break;
            case 3: ctrl->alu_op = 3; break;
            case 4: ctrl->alu_op = 4; break;
        }
    }
...
// STEP
void executar_uma_instrucao(struct simulador *sim) {
...
void menu(struct simulador *sim) {
    ...
    do {
        ...
        switch(op) {
            case 1: executar_uma_instrucao(sim); break;
